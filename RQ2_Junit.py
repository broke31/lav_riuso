...
from Reformat import reformat_ant, reformatted_jedit, reformatted_jhotdraw, reformatted_junit
...
path_to_rq2 = "/home/broke31/Desktop/Lav_riuso/RQ2_j/" + name_folder + "/"
...
for sub_folder in list_sub_folder:
   ...
   # print(df_th)
    df_th_reformatted = reformatted_junit(df_th)
    #  print(df_to_save)
    ...
    print(df_to_save[current_version + "-" + next_version])
    exit(0)
    print(list_class_name)
